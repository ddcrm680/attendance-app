...
export default function PwaStatus() {
  ...
  return online ? null : <div role="status" className="fixed inset-x-0 top-0 z-[60] bg-amber-500 px-3 py-2 text-center text-sm font-medium text-amber-950">You’re offline. Attendance cannot be submitted until you reconnect; no punch has been saved.</div>;
}
